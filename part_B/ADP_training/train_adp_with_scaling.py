...
def train(samples_path="samples_dummy.csv", output_path="eta_dummy_with_scaling.pkl", ridge_lambda=10.0):
    """
...
if __name__ == "__main__":
    ...
    output_path  = os.path.join(base_dir, "eta_dummy_with_scaling.pkl")
